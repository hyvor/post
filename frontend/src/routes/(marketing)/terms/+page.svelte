...
<svelte:head>
	<title>Terms of Service | Hyvor Post</title>
	<link rel="canonical" href="https://post.hyvor.com/terms" />
</svelte:head>
...
<Document title="Terms of Service (Hyvor Post)" subtitle="Last updated: 2025-06-01">
	...
	<p>
		These Terms apply to all users of Hyvor Post (<a href="https://post.hyvor.com"
			>https://post.hyvor.com</a
		>), including:
	</p>
	...
	<p>
		Hyvor Post is a newsletter platform that allows users to create, manage, and send email
		newsletters to subscribers. It is available at <a href="https://post.hyvor.com"
			>https://post.hyvor.com</a
		>.
	</p>
	...
	<p>
		We reserve the right to suspend or terminate accounts that send spam, unsolicited emails, or
		illegal content.
	</p>
	...
	<p>
		Accounts violating these terms may be warned, suspended, or terminated at Hyvor Post's
		discretion.
	</p>
	<hr />
	...
	<p>
		Hyvor Post reserves the right to modify these Terms at any time. Changes will be effective
		immediately upon posting on the Hyvor Post website. Your continued use of the Service after
