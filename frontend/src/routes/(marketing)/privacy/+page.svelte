...
<Document title="Privacy Policy (Hyvor Post)" subtitle="Last Updated: 2025-06-01">
    ...
    <p>We use GDPR-compliant sub-processors (e.g., email delivery providers) to send newsletters and ensure platform
        stability. A full list is available at https://hyvor.com/sub.
    </p>
    ...
    <p>Subscribers have the right to unsubscribe from newsletters at any time. You can do this by clicking the
        "Unsubscribe" link in any newsletter email or by contacting the Hyvor Post user who sent you the newsletter.</p>
</Document>
