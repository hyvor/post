...
<div class="api-key-item">
	<div class="api-key-info">
		...
		<div class="api-key-meta">
			...
			{#if apiKey.last_accessed_at}
				<span
					>{I18n.t('console.settings.api.lastUsed')}: <RelativeTime
						unix={apiKey.last_accessed_at}
					/></span
				>
			{:else}
	...
	<div class="api-key-actions">
		<IconButton variant="fill-light" color="input" size="small" on:click={() => onEdit(apiKey)}>
			<IconPencil size={12} />
		</IconButton>
		<IconButton variant="fill-light" color="red" size="small" on:click={() => onDelete(apiKey)}>
			<IconTrash size={12} />
		</IconButton>
	</div>
</div>
