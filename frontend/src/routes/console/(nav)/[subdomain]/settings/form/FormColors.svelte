...
>
	{#snippet nested()}
		<SplitControl label={i18n.t('console.settings.form.colorBackground')}>
			<ColorPicker
				color={ palette === 'light'
					? $newsletterEditingStore.form_color_light_accent || newsletterDefaults.FORM_COLOR_LIGHT_ACCENT
					: $newsletterEditingStore.form_color_dark_accent || newsletterDefaults.FORM_COLOR_DARK_ACCENT
				}
				on:input={(e) => { palette === 'light'
		...
		<SplitControl label={i18n.t('console.settings.form.colorText')}>
			<ColorPicker
				color={ palette === 'light'
					? $newsletterEditingStore.form_color_light_accent_text || newsletterDefaults.FORM_COLOR_LIGHT_ACCENT_TEXT
					: $newsletterEditingStore.form_color_dark_accent_text || newsletterDefaults.FORM_COLOR_DARK_ACCENT_TEXT
				}
				on:input={(e) => { palette === 'light'
...
>
	{#snippet nested()}
		<SplitControl label={i18n.t('console.settings.form.colorBackground')}>
			<ColorPicker
				color={ palette === 'light'
					? $newsletterEditingStore.form_color_light_input || newsletterDefaults.FORM_COLOR_LIGHT_INPUT
					: $newsletterEditingStore.form_color_dark_input || newsletterDefaults.FORM_COLOR_DARK_INPUT
				}
				on:input={(e) => { palette === 'light'
		...
		<SplitControl label={i18n.t('console.settings.form.colorText')}>
			<ColorPicker
				color={ palette === 'light'
					? $newsletterEditingStore.form_color_light_input_text || newsletterDefaults.FORM_COLOR_LIGHT_INPUT_TEXT
					: $newsletterEditingStore.form_color_dark_input_text || newsletterDefaults.FORM_COLOR_DARK_INPUT_TEXT
				}
				on:input={(e) => { palette === 'light'
		...
		<SplitControl label={i18n.t('console.settings.form.boxShadow')}>
			<BoxShadowPicker
				value={ palette === 'light'
					? $newsletterEditingStore.form_light_input_box_shadow || newsletterDefaults.FORM_LIGHT_INPUT_BOX_SHADOW
					: $newsletterEditingStore.form_dark_input_box_shadow || newsletterDefaults.FORM_DARK_INPUT_BOX_SHADOW
				}
				oninput={(value) => { palette === 'light'
		...
		<SplitControl label={i18n.t('console.settings.form.border')}>
			<BorderPicker
				value={ palette === 'light'
					? $newsletterEditingStore.form_light_input_border || newsletterDefaults.FORM_LIGHT_INPUT_BORDER
					: $newsletterEditingStore.form_dark_input_border || newsletterDefaults.FORM_DARK_INPUT_BORDER
				}
				oninput={(value) => { palette === 'light'
...
>
	<Slider
		...
		value={parseInt(palette === 'light'
			? $newsletterEditingStore.form_light_border_radius ?? newsletterDefaults.FORM_LIGHT_BORDER_RADIUS
			: $newsletterEditingStore.form_dark_border_radius ?? newsletterDefaults.FORM_DARK_BORDER_RADIUS
		)}
		onchange={(value) => { palette === 'light'
