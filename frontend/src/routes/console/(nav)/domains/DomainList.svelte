<script lang="ts">
    ...
    export function refreshDomains(refresh = false) {
        ...
        getDomains()
            .then((res) => {
                ...
                if (!res.some((domain) => domain.relay_status === 'pending' || domain.relay_status === 'warning')) {
    ...
    function startVerificationChecks() {
        ...
        checkInterval = window.setInterval(() => {
            ...
            if (domains.some((domain) => domain.relay_status === 'pending' || domain.relay_status === 'warning')) {
                refreshDomains();
