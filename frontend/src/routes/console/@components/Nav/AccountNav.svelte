<script lang="ts">
    ...
    import {authUserOrganizationStore, userApprovalStatusStore} from '../../lib/stores/consoleStore';
...
<div class="wrap hds-box">
    <div class="nav-links">
        <NavLink
                ...
                disabled={$authUserOrganizationStore.role !== 'admin'}
        >
            <NavItem>
        ...
        >
            <NavLink
                    ...
                    disabled={$userApprovalStatusStore !== 'approved' || (
                        $authUserOrganizationStore.role !== 'admin' && $authUserOrganizationStore.role !== 'billing'
                    )}
            >
                <NavItem>
                    <IconCoin slot="icon"/>
