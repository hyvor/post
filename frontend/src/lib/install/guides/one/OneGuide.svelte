...
<p>
	Embed the signup form on your One.com website to allow visitors to subscribe to your newsletter
...
<GuideSection>
	...
	<ol>
		<li>
			In your One.com website builder dashboard, go to "<b>Widgets</b>" and select "<b
				>Custom Code</b
			>"
		</li>
